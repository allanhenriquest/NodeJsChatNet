/*****************************************************************************************************************
Servidor Para Aplicação de Chat Utilizando Node.Js
*****************************************************************************************************************/

// Criar o servidor, requisitando o protocolo http

var app = require('http').createServer(resposta); 
// Envia o sistema de arquivos do projeto
var fs = require('fs');
// Implementa as Portas Sockets
var io = require('socket.io')(app);
 // Lista de usuários do chat 
var usuarios = [];
// Lista com ultimas mensagens enviadas no chat
var ultimas_mensagens = []; 

//Servidor Escutando na Porta 3000
app.listen(3000);

console.log(" O Servidor do Chat está em execução :)");
...
io.on("connection", function(socket){
	...
	socket.on("entrar", function(apelido, callback){
		if(!(apelido in usuarios)){
            ...
            // Adicionadno o nome de usuário a lista armazenada no servidor
            ...
            // Enviando a nova lista de usuários
			io.sockets.emit("atualizar usuarios", Object.keys(usuarios)); 
			// Enviando mensagem anunciando entrada do novo usuário
            io.sockets.emit("atualizar mensagens", obj_mensagem); 
            // Guardando a mensagem na lista de histórico
